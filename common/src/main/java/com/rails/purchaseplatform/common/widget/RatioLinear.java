...
public class RatioLinear extends androidx.appcompat.widget.LinearLayoutCompat {

    int w = 1;
    int h = 1;

    public RatioLinear(Context context) {
        super(context);
        init(context, null);
    }

    public RatioLinear(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RatioLinear(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
