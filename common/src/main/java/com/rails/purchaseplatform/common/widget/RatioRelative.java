...
public class RatioRelative extends RelativeLayout {
    ...
    public RatioRelative(Context context) {
        super(context);
        init(context, null);
    }

    public RatioRelative(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RatioRelative(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
