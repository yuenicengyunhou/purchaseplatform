...
public class SignCheck {
    ...
    public String getCertificateSHA1Fingerprint() {
        ...
        //签名信息
        Signature[] signatures = Objects.requireNonNull(packageInfo).signatures;
        ...
        try {
            c = (X509Certificate) Objects.requireNonNull(cf).generateCertificate(input);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            //获得公钥
            byte[] publicKey = md.digest(Objects.requireNonNull(c).getEncoded());
