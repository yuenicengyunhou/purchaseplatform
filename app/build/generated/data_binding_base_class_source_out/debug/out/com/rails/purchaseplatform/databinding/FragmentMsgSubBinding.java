...
public final class FragmentMsgSubBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentMsgSubBinding(@NonNull BaseSwipeLayout rootView, @NonNull EmptyView emptyView,
  ...
  @NonNull
  public static FragmentMsgSubBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentMsgSubBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_msg_sub, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentMsgSubBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMsgSubBinding((BaseSwipeLayout) rootView, emptyView, line, recycler,
          swipe);
    }
