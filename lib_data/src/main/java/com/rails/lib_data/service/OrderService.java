...
public interface OrderService {
    ...
    Observable<HttpResult<Object>> commitOrder(@FieldMap HashMap<String, Object> params);
     ...
     * 获取商品名称列表
     */
    @GET("app-user-service/app/v1/buyer/item/querySkuIdListByName")
    Observable<HttpResult<ArrayList<BuyerBean>>> querySkuIdListByName(@QueryMap HashMap<String, Object> params);

    /**
     * 获取商品名称列表
     */
    @GET("app-user-service/app/v1/buyer/brandController/queryBrandForPlatformId")
