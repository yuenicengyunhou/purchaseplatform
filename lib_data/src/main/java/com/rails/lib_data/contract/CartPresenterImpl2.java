...
public class CartPresenterImpl2 extends BasePresenter<CartContract.CartView> implements CartContract.CartPresenter2 {

    private CartModel mModel;

    public CartPresenterImpl2(Activity mContext, CartContract.CartView cartView) {
