...
public class HttpConstants {
     ...
     * Swagger给的新的地址
     */
//    final public static String SHOP_URL = "http://gateway.shop-dev1.rails.cn:80/app-item-service/app/v1/";

    final public static String PLATFORM_URL = "https://crmall.rails.cn/proxy/passport/";
//   final public static String PLATFORM_URL = "http://172.28.22.72:8080/";
