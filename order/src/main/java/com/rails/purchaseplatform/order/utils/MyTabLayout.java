package com.rails.purchaseplatform.order.utils;
...
public class MyTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextSelectColor = ta.getColor(R.styleable.SlidingTabLayout_tl_textSelectColor, ContextCompat.getColor(context,R.color.appThemeRed));
...
//            tabView = View.inflate(mContext, R.layout.layout_tab, null);
            tabView = View.inflate(mContext, R.layout.tab_view_layout, null);
    ...
    public void addNewTab(String title) {
        View tabView = View.inflate(mContext, R.layout.tab_view_layout, null);
        if (mTitles != null) {
            mTitles.add(title);
        }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, i == mCurrentTab ?sp2px(14):mTextsize);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX,isSelect ?sp2px(14):mTextsize);
            }
        }
    }
